...
lmFit2 <- train(compressive_strength~water + water^2,
                data = concrete,
                method = "lm",
                trControl = ctrl1)
lmFit2

lmFit3 <- train(compressive_strength~water + water^2 + water^3,
                data = concrete,
                method = "lm",
                trControl = ctrl1)
lmFit3

lmFit4 <- train(compressive_strength~water + water^2 + water^3 + water^4,
                data = concrete,
                method = "lm",
                trControl = ctrl1)
lmFit4
